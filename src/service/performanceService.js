...
export default {
    ...
    search: async ({ keyword, date, price, region, cursor = null, limit = 10 }) => {
        ...
        if (price) {
            if (price.min) params.append('minPrice', price.min.toString());
            if (price.max) params.append('maxPrice', price.max.toString());
        }
